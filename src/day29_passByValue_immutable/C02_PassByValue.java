...
public class C02_PassByValue {
    public static void main(String[] args) {
        /*
        Birden fazla element iceren array ve array.list gibi yapilarda da
        passByValue gecerlidir.

        Eger method da array veya list in kendisi degistirilirse passByValue ozelligi
        sebebiyle Java degisen degeri degil
        array veya listin original degerini alir

        Ancak array veya list degistirilmeden
        sadece icindeki elemanlar degistirlirse
        ...
        System.out.println("Method call dan sonra main method da array : "
                + Arrays.toString(arr)); // [3, 5, 8, 10]
    }
    ...
    public static void arrayiDegistir(int[] arr) {
        ...
        System.out.println("Method da array : " + Arrays.toString(arr)); // [16, 9, 55]
    }
}
