...
public class C06_DoWhileLoop {
    public static void main(String[] args) {
        ...
        System.out.println(pozSayiAdedi + " adet pozitif tamsayi giriniz, toplamlari : " + pozSayilarTop);
        System.out.println(negSayiAdedi + " adet negatif tamsayi girdiniz ancak onlar toplama dahil edilmedi");
