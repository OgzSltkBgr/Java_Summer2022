...
public class Fp03 {
    public static void main(String[] args) {
        ...
        System.out.println(xIleBaslamiyorrMu(liste));
        System.out.println(herhangiBiriRIleBitiyorMu(liste));
...
//    }
    ...
    public static boolean xIleBaslamiyorrMu(List<String> list){

        return list.stream().noneMatch(t->t.startsWith("X"));
    }
    //11) Herhangi bir elemanın 'r' ile bitip bitmediğini kontrol eden bir method oluşturun.
    public static boolean herhangiBiriRIleBitiyorMu(List<String> list){
