...
public class C10_c09kopya {
    public static void main(String[] args) {
        ...
        */
        ...
        System.out.println("array de değisiklik yapınca sayilar2:"+sayilar2);// burası da değisir, ben array de değisiklik yaptım listemde değil
        // sayilar 2 listesinde değisiklik yapmamama rağmen array de değisiklik yapınca listemde değisiyor, listede değisiklik yapınca array de degisiyor
